      ...
      >
        ...
        <div className=" mt-8 flex flex-col space-y-1">
          ...
          <button
            ...
            text-white bg-[#38ada9] mt-2 py-2 rounded-full"
          >
            + Add New Checklists
          </button>
        </div>
        ...
        <div className=" mt-8 flex flex-col space-y-3">
          ...
          focus:border-0  border-[1px] border-gray-300 focus:outline-[#38ada9] outline-none 
          dark:bg-[#2b2c37]"
          >
          ...
          <button
            ...
            className=" w-full items-center text-white bg-[#38ada9] py-2 rounded-full"
          >
